...
public class ActionSeekNearestTree extends ActionBase
{
    ...
    public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, @Nullable InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store)
    {
        ...
        DebugLog.fine(DebugCategory.WOODSMAN_JOB, "[SeekNearestTree] [%s] Attempting to claim tree at %s.", npcId, nearestTree);
        ...
        world.execute(() -> {
            ...
            {
                DebugLog.fine(DebugCategory.WOODSMAN_JOB, "[SeekNearestTree] [%s] Already has a job target -- skipping claim.", npcId);
                return;
            }
            ...
            if (claimed)
            {
                DebugLog.fine(DebugCategory.WOODSMAN_JOB, "[SeekNearestTree] [%s] Claimed tree at %s -- navigating.", npcId, treePosition);
            }
            else
            {
                DebugLog.fine(DebugCategory.WOODSMAN_JOB, "[SeekNearestTree] [%s] Tree at %s was already taken -- will retry next cycle.", npcId, treePosition);
            }
        });
