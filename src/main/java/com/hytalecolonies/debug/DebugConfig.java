...
public class DebugConfig
{
    public static final BuilderCodec<DebugConfig> CODEC =
            BuilderCodec.builder(DebugConfig.class, DebugConfig::new)
                    .append(new KeyedCodec<>("GeneralLevel", Codec.STRING), (c, v) -> c.generalLevel = v, c -> c.generalLevel)
                    .add()
                    .append(new KeyedCodec<>("MovementLevel", Codec.STRING), (c, v) -> c.movementLevel = v, c -> c.movementLevel)
                    .add()
                    .append(new KeyedCodec<>("JobSystemLevel", Codec.STRING), (c, v) -> c.jobSystemLevel = v, c -> c.jobSystemLevel)
                    .add()
                    .append(new KeyedCodec<>("JobAssignmentLevel", Codec.STRING), (c, v) -> c.jobAssignmentLevel = v, c -> c.jobAssignmentLevel)
                    .add()
                    .append(new KeyedCodec<>("WoodsmanJobLevel", Codec.STRING), (c, v) -> c.woodsmanJobLevel = v, c -> c.woodsmanJobLevel)
                    .add()
                    .append(new KeyedCodec<>("MinerJobLevel", Codec.STRING), (c, v) -> c.minerJobLevel = v, c -> c.minerJobLevel)
                    .add()
                    .append(new KeyedCodec<>("ConstructorJobLevel", Codec.STRING), (c, v) -> c.constructorJobLevel = v, c -> c.constructorJobLevel)
                    .add()
                    .append(new KeyedCodec<>("TreeScannerLevel", Codec.STRING), (c, v) -> c.treeScannerLevel = v, c -> c.treeScannerLevel)
                    .add()
                    .append(new KeyedCodec<>("ColonistDeliveryLevel", Codec.STRING), (c, v) -> c.colonistDeliveryLevel = v, c -> c.colonistDeliveryLevel)
                    .add()
                    .append(new KeyedCodec<>("ClaimSystemLevel", Codec.STRING), (c, v) -> c.claimSystemLevel = v, c -> c.claimSystemLevel)
                    .add()
                    .append(new KeyedCodec<>("ColonistLifecycleLevel", Codec.STRING), (c, v) -> c.colonistLifecycleLevel = v, c -> c.colonistLifecycleLevel)
                    .add()
                    .append(new KeyedCodec<>("DrawColonistPaths", Codec.BOOLEAN), (c, v) -> c.drawColonistPaths = v, c -> c.drawColonistPaths)
                    .add()
                    .append(new KeyedCodec<>("DrawTreeDetection", Codec.BOOLEAN), (c, v) -> c.drawTreeDetection = v, c -> c.drawTreeDetection)
                    .add()
                    .append(new KeyedCodec<>("DrawConstructorOrders", Codec.BOOLEAN), (c, v) -> c.drawConstructorOrders = v, c -> c.drawConstructorOrders)
                    .add()
                    .append(new KeyedCodec<>("PerformanceLevel", Codec.STRING), (c, v) -> c.performanceLevel = v, c -> c.performanceLevel)
                    .add()
                    .build();
    ...
    public boolean isDrawColonistPaths()
    {
        return drawColonistPaths;
    }

    public void setDrawColonistPaths(boolean v)
    {
        drawColonistPaths = v;
    }

    public boolean isDrawTreeDetection()
    {
        return drawTreeDetection;
    }

    public void setDrawTreeDetection(boolean v)
    {
        drawTreeDetection = v;
    }

    public boolean isDrawConstructorOrders()
    {
        return drawConstructorOrders;
    }

    public void setDrawConstructorOrders(boolean v)
    {
        drawConstructorOrders = v;
    }
