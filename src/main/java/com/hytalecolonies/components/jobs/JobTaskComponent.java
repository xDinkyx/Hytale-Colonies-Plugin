...
public class JobTaskComponent implements Component<EntityStore> {
    ...
    public static final BuilderCodec<JobTaskComponent> CODEC = BuilderCodec
            .builder(JobTaskComponent.class, JobTaskComponent::new)
            .append(new KeyedCodec<>("RequiredItems", ItemRequirement.ARRAY_CODEC),
                    (o, v) -> o.requiredItems = v,
                    o -> o.requiredItems)
            .add()
            .build();
