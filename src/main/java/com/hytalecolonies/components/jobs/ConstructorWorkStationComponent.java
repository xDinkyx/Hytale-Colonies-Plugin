...
{
    // ===== Codec =====
    public static final BuilderCodec<ConstructorWorkStationComponent> CODEC =
            BuilderCodec.builder(ConstructorWorkStationComponent.class, ConstructorWorkStationComponent::new)
                    .append(new KeyedCodec<>("ActiveOrderId", Codec.UUID_STRING), (o, v) -> o.activeOrderId = v, o -> o.activeOrderId)
                    .add()
                    .build();
