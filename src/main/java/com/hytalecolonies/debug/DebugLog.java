 ...
 *
 * <p>
 * Each method corresponds to a specific log level. The category's configured minimum level ({@link DebugCategory#getMinLevel()}) acts as a threshold: messages
 * below it are silently discarded. Setting a category to {@link Level#OFF} suppresses all its output.
 *
 * <pre>{@code
...
public final class DebugLog
{
    ...
    /**
     * Returns the UUID string of the NPC entity for use in log messages, or {@code "?"} if no {@link UUIDComponent} is present.
     */
