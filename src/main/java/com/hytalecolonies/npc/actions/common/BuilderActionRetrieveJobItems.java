...
public class BuilderActionRetrieveJobItems extends BuilderActionBase
{
    ...
    {
        return "Tries to get all the items needed for a task from the workstation container. Both the required items and tools for the job as defined by the "
                + "workstation and the items needed to perform the current task; like blocks to build or items to craft.";
    }
