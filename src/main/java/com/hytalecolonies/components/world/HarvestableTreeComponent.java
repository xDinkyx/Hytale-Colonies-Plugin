...
/**
 * Component representing a harvestable tree structure, identified by the TreeScannerSystem and its ITreeDetector implementations.
 *
 * <p>
 * Whether a tree is currently reserved by a colonist is tracked by the presence of a {@link ClaimedBlockComponent} on the same block entity -- not by any field
 * on this component.
 */
public class HarvestableTreeComponent implements Component<ChunkStore>
{
    // ===== Codec =====
    public static final BuilderCodec<HarvestableTreeComponent> CODEC =
            BuilderCodec.builder(HarvestableTreeComponent.class, HarvestableTreeComponent::new)
                    .append(new KeyedCodec<>("TreeTypeKey", Codec.STRING), (o, v) -> o.treeTypeKey = v, o -> o.treeTypeKey)
                    .add()
