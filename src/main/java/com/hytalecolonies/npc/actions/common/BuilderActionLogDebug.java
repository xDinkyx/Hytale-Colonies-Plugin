 ...
 *
 * <p>
 * JSON: {@code { "Type": "LogDebug", "Message": "...", "Category": "JOB_SYSTEM", "Level": "INFO" }}
 */
public class BuilderActionLogDebug extends BuilderActionBase
{
    ...
    {
        return "Useful for tracing StateTransitions and Instructions. Parameters: Message, Category (default GENERAL), Level (default INFO; use DEBUG as "
                + "alias for FINE).";
    }
    ...
    {
        this.getString(data, "Message", this.message, "(no message)", null, BuilderDescriptorState.WorkInProgress, "The message to log.", null);
        this.getString(data,
                       "Category",
                       this.category,
                       "GENERAL",
                       ...
                       "DebugCategory to log to (e.g. GENERAL, WOODSMAN_JOB, MINER_JOB, JOB_SYSTEM).",
                       null);
        this.getString(data,
                       "Level",
                       this.level,
                       ...
                       null,
                       BuilderDescriptorState.WorkInProgress,
                       "Log level: OFF, FINE, DEBUG (alias for FINE), INFO, WARNING, SEVERE.",
                       null);
        return this;
    }
