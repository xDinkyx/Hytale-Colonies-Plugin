 ...
 *
 * <p>
 * Fires when the entity has an active job target position and is within the configured range of it. Provides the target position so that actions (e.g.
 * {@code HarvestBlock}) can receive it via {@code sensorInfo}.
 *
 * <p>
 ...
 *
 * <p>
 * Registered via {@code NPCPlugin.get().registerCoreComponentType("JobTarget", ...)} in {@link com.hytalecolonies.HytaleColoniesPlugin#setup()}.
 */
public class BuilderSensorJobTarget extends BuilderSensorBase
{
    ...
    public Builder<Sensor> readConfig(@Nonnull JsonElement data)
    {
        this.requireDouble(data,
                           ...
                           "Maximum horizontal distance from the target position for the sensor to fire",
                           null);
