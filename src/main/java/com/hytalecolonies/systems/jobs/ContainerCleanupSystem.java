...
public class ContainerCleanupSystem extends RefSystem<ChunkStore>
{
    ...
    private final Query<EntityStore> colonistQuery = Query.and(ColonistComponent.getComponentType(), JobComponent.getComponentType());
