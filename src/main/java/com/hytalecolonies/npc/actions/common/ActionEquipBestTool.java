...
/**
 * Equips the best available tool from the NPC's inventory. Uses the configured {@code GatherType}, or auto-detects from the sensor block position.
 *
 * <p>
 * Constructed by {@link BuilderActionEquipBestTool}.
 */
public class ActionEquipBestTool extends ActionBase
{
    ...
    public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, @Nullable InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store)
    {
        ...
        if (pos == null || !pos.providePosition(targetVec))
            return false;
