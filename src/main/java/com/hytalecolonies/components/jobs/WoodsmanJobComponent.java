...
/**
 * Per-colonist component for woodsman colonists. Carries runtime state that is meaningful across restarts; all job configuration (allowed tree types, search
 * radius) lives in {@link WorkStationComponent}.
 */
public class WoodsmanJobComponent implements Component<EntityStore>
{
    // ===== Codec =====
    public static final BuilderCodec<WoodsmanJobComponent> CODEC =
            BuilderCodec
