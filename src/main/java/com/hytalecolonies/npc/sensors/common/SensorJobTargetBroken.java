...
/**
 * Runtime sensor -- fires when {@link JobTargetComponent} has a position AND the block at that position is air (id == 0), meaning the target block was broken.
 */
public class SensorJobTargetBroken extends SensorBase
{
    public SensorJobTargetBroken(@Nonnull BuilderSensorJobTargetBroken builder, @Nonnull BuilderSupport support)
    {
        super(builder);
    }
