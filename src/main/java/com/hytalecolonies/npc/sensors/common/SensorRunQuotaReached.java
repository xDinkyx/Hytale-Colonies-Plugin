...
/**
 * Fires when {@link JobRunCounterComponent#count} is at or above {@link WorkStationComponent#blocksPerRun}. Usable by any job type that enforces a per-run
 * block quota.
 */
public class SensorRunQuotaReached extends SensorBase
{
    public SensorRunQuotaReached(@Nonnull BuilderSensorRunQuotaReached builder, @Nonnull BuilderSupport support)
    {
        super(builder);
    }
