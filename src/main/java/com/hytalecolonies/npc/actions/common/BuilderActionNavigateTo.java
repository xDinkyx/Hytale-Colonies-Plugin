 ...
 *
 * <p>
 * JSON: {@code { "Type": "NavigateTo", "Target": "Workstation" }}
 *
 * <p>
 * Supported {@code Target} values:
 * <ul>
...
public class BuilderActionNavigateTo extends BuilderActionBase
{
    ...
    {
        return "Dispatches navigation toward the named target using MoveToTargetComponent.";
    }
    ...
    public Builder<Action> readConfig(@Nonnull JsonElement data)
    {
        this.getString(data,
                       ...
                       "Navigation target type. Supported: Workstation, JobTarget.",
                       null);
        return this;
    }
