...
public class WoodsmanWorkStationComponent implements Component<ChunkStore>
{
    ...
    // ===== Codec =====
    public static final BuilderCodec<WoodsmanWorkStationComponent> CODEC =
            BuilderCodec.builder(WoodsmanWorkStationComponent.class, WoodsmanWorkStationComponent::new)
                    .append(new KeyedCodec<>("TreeSearchRadius", Codec.FLOAT), (o, v) -> o.treeSearchRadius = v, o -> o.treeSearchRadius)
                    .add()
                    .append(new KeyedCodec<>("AllowedTreeTypes", new SetCodec<>(Codec.STRING, HashSet::new, false)),
                            (o, v)
                                    -> o.allowedTreeTypes = v,
